...
struct BiliPlayerViewContent: View {
    ...
    private var surfaceGestureLayer: some View {
        Group {
            if libraryStore.usesNativePlaybackControls {
                playbackSurface
            } else {
    ...
    private var playbackSurface: some View {
        VideoSurfaceView(
            viewModel: context.viewModel,
            prefersNativePlaybackControls: libraryStore.usesNativePlaybackControls,
    ...
    private var surfaceChromeState: BiliPlayerSurfaceChromeState {
        BiliPlayerSurfaceChromeState(
            ...
            topTrailingControlsAccessory: !libraryStore.usesNativePlaybackControls && context.configuration.showsMoreControls
