...
final class LibraryStore: ObservableObject {
    ...
    func setUsesNativePlaybackControls(_ isEnabled: Bool) {
        usesNativePlaybackControls = isEnabled
        userDefaults.set(isEnabled, forKey: Self.usesNativePlaybackControlsKey)
    }
